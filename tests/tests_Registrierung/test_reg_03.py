...
@allure.story("Registration - password mismatch")
@allure.severity(allure.severity_level.NORMAL)
@allure.title("Registration fails when passwords do not match")
def test_register(page):
    ...
    with allure.step("Fill registration form with mismatching passwords"):
        page.get_by_role("textbox", name="Username").click()
    ...
    with allure.step("Verify password mismatch error is shown"):
        expect(page.get_by_text("Die Passwörter stimmen nicht")).to_be_visible()
